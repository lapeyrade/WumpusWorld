...
*   **Multiple AI Control Mechanisms**:
    ...
    *   **Prolog-Based Logical AI with Meta-Interpreter**: Employs SWI-Prolog for reasoning, using a defined knowledge base, ontologies and a meta-interpreter([`AIPrologMetaInterpreter.cs`](Assets/Scripts/Agent/AI/AIProlog.cs) with [Prolog files](Assets/StreamingAssets/prolog_meta/)).
